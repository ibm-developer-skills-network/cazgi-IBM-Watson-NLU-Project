...
var VisualRecognitionV4 = /** @class */ (function (_super) {
     ...
     */
    VisualRecognitionV4.prototype.analyze = function (params) {
     ...
     */
    VisualRecognitionV4.prototype.createCollection = function (params) {
        var _params = Object.assign({}, params);
        var body = {
            'name': _params.name,
     ...
     */
    VisualRecognitionV4.prototype.listCollections = function (params) {
        var _params = Object.assign({}, params);
        var query = {
            'version': this.version
        };
     ...
     * @returns {Promise<VisualRecognitionV4.Response<VisualRecognitionV4.Collection>>}
     */
    VisualRecognitionV4.prototype.getCollection = function (params) {
        var _params = Object.assign({}, params);
     ...
     * @returns {Promise<VisualRecognitionV4.Response<VisualRecognitionV4.Collection>>}
     */
    VisualRecognitionV4.prototype.updateCollection = function (params) {
        var _params = Object.assign({}, params);
        var requiredParams = ['collectionId'];
        var missingParams = ibm_cloud_sdk_core_1.getMissingParams(_params, requiredParams);
        if (missingParams) {
     ...
     */
    VisualRecognitionV4.prototype.deleteCollection = function (params) {
        var _params = Object.assign({}, params);
        var requiredParams = ['collectionId'];
        var missingParams = ibm_cloud_sdk_core_1.getMissingParams(_params, requiredParams);
        if (missingParams) {
     ...
     */
    VisualRecognitionV4.prototype.getModelFile = function (params) {
        var _params = Object.assign({}, params);
     ...
     */
    VisualRecognitionV4.prototype.addImages = function (params) {
        var _params = Object.assign({}, params);
        var requiredParams = ['collectionId'];
        var missingParams = ibm_cloud_sdk_core_1.getMissingParams(_params, requiredParams);
        if (missingParams) {
     ...
     */
    VisualRecognitionV4.prototype.listImages = function (params) {
        var _params = Object.assign({}, params);
        var requiredParams = ['collectionId'];
        var missingParams = ibm_cloud_sdk_core_1.getMissingParams(_params, requiredParams);
        if (missingParams) {
     ...
     */
    VisualRecognitionV4.prototype.getImageDetails = function (params) {
        var _params = Object.assign({}, params);
     ...
     * @returns {Promise<VisualRecognitionV4.Response<VisualRecognitionV4.Empty>>}
     */
    VisualRecognitionV4.prototype.deleteImage = function (params) {
        var _params = Object.assign({}, params);
        var requiredParams = ['collectionId', 'imageId'];
        var missingParams = ibm_cloud_sdk_core_1.getMissingParams(_params, requiredParams);
        if (missingParams) {
     ...
     * @returns {Promise<VisualRecognitionV4.Response<NodeJS.ReadableStream|Buffer>>}
     */
    VisualRecognitionV4.prototype.getJpegImage = function (params) {
        var _params = Object.assign({}, params);
        var requiredParams = ['collectionId', 'imageId'];
        var missingParams = ibm_cloud_sdk_core_1.getMissingParams(_params, requiredParams);
        if (missingParams) {
     ...
     */
    VisualRecognitionV4.prototype.listObjectMetadata = function (params) {
        var _params = Object.assign({}, params);
        var requiredParams = ['collectionId'];
        var missingParams = ibm_cloud_sdk_core_1.getMissingParams(_params, requiredParams);
        if (missingParams) {
     ...
     */
    VisualRecognitionV4.prototype.updateObjectMetadata = function (params) {
        var _params = Object.assign({}, params);
     ...
     */
    VisualRecognitionV4.prototype.getObjectMetadata = function (params) {
        var _params = Object.assign({}, params);
     ...
     * @returns {Promise<VisualRecognitionV4.Response<VisualRecognitionV4.Empty>>}
     */
    VisualRecognitionV4.prototype.deleteObject = function (params) {
        var _params = Object.assign({}, params);
        var requiredParams = ['collectionId', 'object'];
        var missingParams = ibm_cloud_sdk_core_1.getMissingParams(_params, requiredParams);
        if (missingParams) {
     ...
     * @returns {Promise<VisualRecognitionV4.Response<VisualRecognitionV4.Collection>>}
     */
    VisualRecognitionV4.prototype.train = function (params) {
        var _params = Object.assign({}, params);
        var requiredParams = ['collectionId'];
        var missingParams = ibm_cloud_sdk_core_1.getMissingParams(_params, requiredParams);
        if (missingParams) {
     ...
     */
    VisualRecognitionV4.prototype.addImageTrainingData = function (params) {
        var _params = Object.assign({}, params);
        var requiredParams = ['collectionId', 'imageId'];
        var missingParams = ibm_cloud_sdk_core_1.getMissingParams(_params, requiredParams);
        if (missingParams) {
     ...
     */
    VisualRecognitionV4.prototype.getTrainingUsage = function (params) {
        var _params = Object.assign({}, params);
        var query = {
            'version': this.version,
     ...
     * @returns {Promise<VisualRecognitionV4.Response<VisualRecognitionV4.Empty>>}
     */
    VisualRecognitionV4.prototype.deleteUserData = function (params) {
        var _params = Object.assign({}, params);
